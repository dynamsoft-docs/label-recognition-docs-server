...
description: API reference for the RecognizedTextLineElement class in Dynamsoft Label Recognizer Java Edition, which represents a line of recognized text with its content and confidence score.
